 ...
 *
 * In this market WhatsApp is where business conversations actually start, so
 * it earns a permanent slot — but it stays out of the way: it only appears
 * once the hero is behind you, and it collapses to the mark alone on mobile.
 */
export default function WhatsAppButton({ href }: { href: string }) {
  ...
  return (
    <a
      ...
      aria-label="Message Claudius &amp; Co. on WhatsApp"
    >
      <WhatsAppGlyph />
      <span>WhatsApp</span>
    </a>
